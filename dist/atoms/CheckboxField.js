...
const CheckboxField = (props) => {
    ...
    return ((0, jsx_runtime_1.jsx)(Item, Object.assign({ required: required, label: label, help: touched && error, validateStatus: error && touched ? 'error' : undefined, style: style }, { children: (0, jsx_runtime_1.jsx)(antd_1.Row, { children: (0, jsx_runtime_1.jsx)(antd_1.Checkbox, Object.assign({}, input, { id: (0, helper_1.formFieldID)(form, input.name), checked: !!input.value, disabled: disabled }, { children: placeholder })) }) })));
};
