...
const CheckMark_1 = __importDefault(require("../assets/icons/CheckMark"));
...
const renderMenuItemSelectedIcon = (mode, menuItemSelectedIcon, disableMenuItemSelectedIcon) => {
    ...
    if (menuItemSelectedIcon) {
        ...
        icon = (0, jsx_runtime_1.jsx)(CheckMark_1.default, {}) || menuItemSelectedIcon;
    }
    return icon;
};
