...
const TextareaField = (props) => {
    const { input, prefix, disabled, label, placeholder, required, meta: { error, touched, valid }, rows, autoSize, allowClear, style, maxLength, focusRow, readOnly, className, size, showLettersCount } = props;
