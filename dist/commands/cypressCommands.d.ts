...
export declare const setInputValue: (form: string, key: string, value: string, force?: boolean, clear?: boolean) => void;
export declare const selectOptionDropdown: (form: string, key: string, value?: string) => void;
export declare const setSearchBoxValueAndSelectFirstOption: (key: string, value: string, selectListKey: string, form?: string, googleGeocoding?: boolean, clear?: boolean, timeout?: number) => void;
