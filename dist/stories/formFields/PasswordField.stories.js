...
const InputPasswordField_1 = __importDefault(require("../../atoms/InputPasswordField"));
...
exports.default = {
    ...
    component: InputPasswordField_1.default,
...
const Template = (args) => ((0, jsx_runtime_1.jsx)(antd_1.Form, Object.assign({ layout: 'vertical' }, { children: (0, jsx_runtime_1.jsx)(InputPasswordField_1.default, Object.assign({}, args)) })));
// stories
