...
const customDropdown = (actions: Action[] | null | undefined, menu: React.ReactElement, fetching: boolean | undefined, indicator: any) => {
...
const SelectField = (props: Props) => {
	...
	useEffect(() => {
		...
		if (values.size > 0) handleSearch('', 1, [...values] as any)
